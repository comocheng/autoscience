...
# Load the base model
# basedir = '/work/westgroup/harris.se/autoscience/autoscience/butane/rmg_model'  # input model
basedir = '/work/westgroup/harris.se/autoscience/autoscience/butane/naive_rmg_model'  # input model - naive RMG
model_dir = '/scratch/harris.se/autoscience/naive_model/sensitivity/models'  # where the output cti's go
