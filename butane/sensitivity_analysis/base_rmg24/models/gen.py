...
model_dir = '/work/westgroup/harris.se/autoscience/autoscience/butane/sensitivity_analysis/base_rmg24/models'  # where the output cti's go
...
def save_new_cti(model_index):
    ...
    if model_index < len(reaction_list):
        delta = 0.1
        try:
        ...
        param_index = model_index - len(reaction_list)
        delta = 0.1
